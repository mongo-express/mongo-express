...
- Added support for NaN, +Inifity, -Infinity values [(#395)](github.com/mongo-express/mongo-express/pulls/395)


# 0.45 - Sun Mar 4, 2018


- Added `VCAP_APP_PORT` in config [(#378)](github.com/mongo-express/mongo-express/pulls/378)
- Prevent uncaught error if collection has been deleted. [(#382)](github.com/mongo-express/mongo-express/pulls/382)
- export query results from collections [(#388)](github.com/mongo-express/mongo-express/pulls/388)
- Allow hyphens in collection names [(#389)](github.com/mongo-express/mongo-express/pulls/389)


# 0.44.0 - Tue Nov 7, 2017


- Confirm document delete [(#374)](github.com/mongo-express/mongo-express/pulls/374)


# 0.43.1 - Tue Oct 24, 2017


- Fix can not delete database [(#373)](github.com/mongo-express/mongo-express/pulls/373)


# 0.43.0 - Sat Oct 14, 2017


- Added support for Binary Data as _id [(#368)](github.com/mongo-express/mongo-express/pulls/368)


# 0.42.3 - Sat Sep 23, 2017


- Fix small typo causing issue with auth databases [(#366)](github.com/mongo-express/mongo-express/pulls/366)
...
- Fixed typo in tag of collection view [(#357)](github.com/mongo-express/mongo-express/pulls/357)


# 0.42.0 - Thu Jul 20, 2017


- Add connectionString support to connection [(#350)](github.com/mongo-express/mongo-express/pulls/350)


# 0.41.0 - Tue Jul 4, 2017


- Use stream for exporting collections [(#345)](github.com/mongo-express/mongo-express/pulls/345)
- Solution for CSRF wiht base url [(#347)](github.com/mongo-express/mongo-express/pulls/347)


# 0.40.0 - Mon May 1, 2017


- Fixed more flexible db names [(#339)](github.com/mongo-express/mongo-express/pulls/339)
- Fixed escaping in nested objects
- Fixed path resolve for windows for the builds
- Fixed revise the list database function to support user having access to admin database [(#338)](github.com/mongo-express/mongo-express/pulls/338)
...
## New
* Support for mounting on a different baseHref [(#320)](github.com/mongo-express/mongo-express/pulls/320)

## Chores
* Improve configuration step [(#321)](github.com/mongo-express/mongo-express/pulls/321)
...
## New
* Added support for Collection with slash in the name [(#309)](github.com/mongo-express/mongo-express/pulls/309)
* Changed the way scripts work [(#312)](github.com/mongo-express/mongo-express/pulls/312)
...
## Fixes
* Fixed issue where parenthese we're stringified incorrectly [(#306)](github.com/mongo-express/mongo-express/pulls/306)
* Fixed loadDocument script that was rendered properly in read-only [(#308)](github.com/mongo-express/mongo-express/pulls/308)

## Varia
* Removed underscore and use only lodash. [(#307)](github.com/mongo-express/mongo-express/pulls/307)
* Removed Snyk. It was causing more annoyance than actual good [(#306)](github.com/mongo-express/mongo-express/pulls/306)
* Updated swig to swig-template, which uses a safe version [(#311)](github.com/mongo-express/mongo-express/pulls/311)


# 0.36.0 - Tue Feb 7, 2017

* Fix content-disposition non-ascii header, set config.gridFSEnabled via env vars [(#304)](github.com/mongo-express/mongo-express/pulls/304)

# 0.35.0 - Thu Jan 5, 2017

* Removed Duplicated navbar in mobile layout [(#302)](github.com/mongo-express/mongo-express/pulls/302)
* Add logger options to control logging [(#300)](github.com/mongo-express/mongo-express/pulls/300)
* Pass options in middleware-only usage [(#299)](github.com/mongo-express/mongo-express/pulls/299)

# 0.34.0 - Fri Dec 23, 2016


## Fixes
* Fixed index are no longer deletable in read-only mode [(#298)](github.com/mongo-express/mongo-express/pulls/298)
