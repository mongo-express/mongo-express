...
| `ME_CONFIG_OIDCAUTH_ACRVALUES`                 | ``                                                  | The acr_values (Authentication Context Class Reference) to be sent during the OIDC login.                                                                                       |
| `ME_CONFIG_OIDCAUTH_AUTHORIZATION_PARAMS_SCOPE`| `openid profile email`                              | Space-separated list of OIDC scopes to request from the provider (e.g., openid profile email eduperson_entitlement).                                                            |
