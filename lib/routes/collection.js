...
var routes = function (config) {
  ...
  exp.viewCollection = function (req, res) {
    ...
    var query_options = exp._getQueryOptions(req);
    var query = exp._getQuery(req, res);
    var projection = exp._getProjection(req);
  ...
  exp.exportCollection = function (req, res) {
    ...
    var query_options = exp._getQueryOptions(req, res);
    var query = exp._getQuery(req, res);
    var projection = exp._getProjection(req, res);
