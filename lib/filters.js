...
exports.to_display = function (input) {
  ...
  if (
    ...
    return '<img src="' + entifyGTLTAmp(input) + '" style="max-height:100%; max-width:100%; " alt="' +  entifyGTLTAmp(input) + '/>';
  }
  ...
  if (
    ...
    return '<video controls><source type="' + input.substring(input.indexOf(':') + 1, input.indexOf(';')) + '" src="' + entifyGTLTAmp(input) + '"/>' +
